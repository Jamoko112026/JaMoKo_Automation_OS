...
| ID | Typ | Name | Status |
|---|---|---|---|
| WF-0001 | Workflow | Task Intake | active |
...
- Reservierte IDs dürfen nicht anderweitig vergeben werden.
- Neue Workflow-IDs werden unmittelbar im ID-Register und im Workflow-Register dokumentiert.